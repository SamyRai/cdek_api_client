...
let(:recipient) do
    ...
    let(:order_data) do
      CDEKApiClient::Entities::OrderData.new(
        ...
        from_location: CDEKApiClient::Entities::Location.new(code: 16584, city: Faker::Address.city, address: Faker::Address.full_address),
        to_location: CDEKApiClient::Entities::Location.new(code: 16584, city: Faker::Address.city, address: Faker::Address.full_address),
        recipient: recipient,
        sender: sender,
        packages: [package],
        comment: Faker::Lorem.sentence,
        services: [
          CDEKApiClient::Entities::Service.new(code: "INSURANCE", price: Faker::Commerce.price(range: 10..1000).to_i, name: Faker::Commerce.product_name),
        ]
      )
    end
