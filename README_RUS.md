...
Ruby клиент для взаимодействия с CDEK API, предоставляющий функциональность для создания заказов, отслеживания, расчета тарифов, получения данных о местоположениях и управления вебхуками. Этот gem обеспечивает чистый, надежный и поддерживаемый код с надлежащей валидацией.

Этот Readme также доступен на:

- [English](README.md)
- [Татарском](README_TAT.md)
