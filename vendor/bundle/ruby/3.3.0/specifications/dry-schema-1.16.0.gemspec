# -*- encoding: utf-8 -*-
# stub: dry-schema 1.16.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "allowed_push_host" => "https://rubygems.org", "bug_tracker_uri" => "https://github.com/dry-rb/dry-schema/issues", "changelog_uri" => "https://github.com/dry-rb/dry-schema/blob/main/CHANGELOG.md", "funding_uri" => "https://github.com/sponsors/hanami", "source_code_uri" => "https://github.com/dry-rb/dry-schema" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<dry-logic>.freeze, ["~> 1.6".freeze])
  s.add_runtime_dependency(%q<dry-types>.freeze, ["~> 1.9".freeze, ">= 1.9.1".freeze])
